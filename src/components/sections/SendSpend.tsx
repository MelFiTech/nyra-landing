...
export default function SendSpend() {
  return (
    <section className="relative min-h-screen flex items-start justify-center overflow-hidden bg-[#F5F5F6]">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          >
            <Button 
              variant="primary" 
              size="lg"
              className="bg-[#CEFE65] text-black hover:bg-[#CEFE65]/90 font-semibold text-sm md:text-base"
            >
              DOWNLOAD NYRA
            </Button>
          </motion.div>
          ...
          >
            <Image 
              src="/images/coin-stack-mobile.svg"
              alt="Coin stack illustration"
              width={351.33}
              height={303}
      ...
      <footer className="fixed bottom-0 left-0 right-0 w-full py-6 px-8 z-50 hidden md:block">
