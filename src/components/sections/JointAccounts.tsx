    ...
    <section className="relative bg-[#F5F5F6] min-h-screen flex items-start justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10 flex flex-col items-center justify-center pt-[120px] md:pt-[220px]">
        <div className="flex flex-col items-center text-center">
          ...
          <motion.div 
            className="mt-16 relative flex justify-center w-full md:hidden"
            initial={{ opacity: 0, y: 40 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.6, duration: 0.8 }}
          >
            <Image 
              src="/images/characters-mobile.svg" 
              alt="Joint Account Characters"
              width={315}
              height={317}
          ...
          {/* Desktop Characters */}
          <motion.div 
            className="mt-80 absolute -translate-y-[100%] hidden md:block"
            initial={{ opacity: 0, y: 40 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.6, duration: 0.8 }}
          >
            <div className="relative w-[1222.55px] h-[705px]">
              <Image 
        ...
        <div className="max-w-[1400px] mx-auto flex justify-between items-center">
          ...
          <div className="flex gap-6">
            <a 
              ...
              className="text-[#87A83D] hover:text-[#87A83D]/80 transition-colors p-2"
              target="_blank"
            ...
            <a 
              href="https://www.tiktok.com/@nyrawallet" 
              className="text-[#87A83D] hover:text-[#87A83D]/80 transition-colors p-2"
              target="_blank"
              rel="noopener noreferrer"
            >
